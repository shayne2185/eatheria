// ===============================
// EATHERIA ZEN – CORE GAMEPLAY (FIXED)
// ===============================
...
canvas.addEventListener("pointerup", e => {
  ...
  const c = Math.floor((swipeStart.x - gridOffsetX) / SIZE);
  const r = Math.floor((swipeStart.y - gridOffsetY) / SIZE);
...
function swap(r1, c1, r2, c2) {
  ...
  let matches = findMatches();
  if (matches.length) resolveMatches();
...
function drawGrid() {
  const colors = ["#22c55e", "#64748b", "#f97316", "#38bdf8", "#e5e7eb"];
