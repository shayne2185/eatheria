...
startBtn.onclick = () => {
  ...
  resize();
  initGrid();
  // ✔️ hneď po vytvorení gridu vyčistíme prípadné auto-matchy
  resolveAllMatches();
...
function handleSingleSwipe(dx, dy, startX, startY) {
  ...
  // push-up jedným prstom, ak swipe začne pod gridom
...
function swap(r1, c1, r2, c2) {
  ...
  // po swape vždy skúsime auto-match
...
function doPushUp() {
  pushUp();
  startPushAnim();
  // ✔️ teraz po push-up okamžite vyčistíme všetky match‑3+
  resolveAllMatches();
}
